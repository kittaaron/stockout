...
def craw(url, key_word, x):
    ...
    try:
        ...
        for i in range(0, len(com_all_info_array)):
            ...
            print("temp_g_name: " + temp_g_name + ",temp_g_tag: " + temp_g_tag + ",temp_r_name: " + temp_r_name +
                  ",temp_g_money: " + temp_g_money + ",temp_g_date: " + temp_g_date + ",temp_r_email: " + temp_r_email +
                  ",temp_r_phone: " + temp_r_phone + ",temp_g_addr: " + temp_g_addr + ",temp_g_state: " + temp_g_state)
...
if __name__ == '__main__':
    ...
    for x in range(1, num):
        url = r'https://www.qichacha.com/search_index?key={}&ajaxflag=1&'.format(key_word, x)
